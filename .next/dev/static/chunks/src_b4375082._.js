    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (statsInView && !hasAnimated) {
                setHasAnimated(true);
                const animate = {
                    "Home.useEffect.animate": (setter, end, duration = 2000)=>{
                        let start = 0;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const observers = stepRefs.current.map({
                "Home.useEffect.observers": (ref, idx)=>{
                    if (!ref) return null;
                    const observer = new IntersectionObserver({
                        "Home.useEffect.observers": ([entry])=>{
            ...
            return ({
                "Home.useEffect": ()=>{
                    observers.forEach({
                        "Home.useEffect": (observer)=>observer?.disconnect()
                    }["Home.useEffect"]);
                }
            })["Home.useEffect"];
        }
...
_s(Home, "pJzydStC2DNHzgXbc7ZgorEVghA=", false, function() {
    return [
