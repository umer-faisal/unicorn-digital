    ...
    <div className="min-h-screen bg-neutral-muted text-text-base">
      ...
      <main>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-neutral-muted rounded-lg p-8 border border-brand-soft">
                <div className="grid grid-cols-2 gap-6">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold text-brand-primary mb-2">150+</div>
                    <div className="text-text-muted">Happy Clients</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-brand-primary mb-2">50+</div>
                    <div className="text-text-muted">Expert Partners</div>
                  </div>
                  <div className="text-center">
        ...
        <section className="py-20 bg-neutral-muted">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-brand-dark mb-6">Our Values</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-neutral-muted rounded-lg p-8 border border-brand-soft text-center">
                <div className="w-16 h-16 bg-brand-soft rounded-full flex items-center justify-center mx-auto mb-6">
                  <i className="ri-shield-check-line text-brand-primary text-2xl"></i>
                </div>
                <h3 className="text-2xl font-bold text-brand-dark mb-4">Trust & Transparency</h3>
              ...
              <div className="bg-neutral-muted rounded-lg p-8 border border-brand-soft text-center">
                <div className="w-16 h-16 bg-brand-soft rounded-full flex items-center justify-center mx-auto mb-6">
                  <i className="ri-star-line text-brand-primary text-2xl"></i>
                </div>
                <h3 className="text-2xl font-bold text-brand-dark mb-4">Excellence</h3>
                <p className="text-text-muted leading-relaxed">
              ...
              <div className="bg-neutral-muted rounded-lg p-8 border border-brand-soft text-center">
                <div className="w-16 h-16 bg-brand-soft rounded-full flex items-center justify-center mx-auto mb-6">
                  <i className="ri-lightbulb-line text-brand-primary text-2xl"></i>
                </div>
                <h3 className="text-2xl font-bold text-brand-dark mb-4">Innovation</h3>
                <p className="text-text-muted leading-relaxed">
        ...
        <section className="py-20 bg-neutral-base">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-brand-dark mb-6">Our Leadership Team</h2>
              <p className="text-xl text-text-muted max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className="bg-neutral-muted rounded-lg p-6 border border-brand-soft text-center">
                  <img 
                    src={member.image} 
                    alt={member.name}
                    className="w-20 h-20 rounded-full mx-auto mb-4 object-cover object-top"
                  />
                  <h3 className="text-lg font-bold text-brand-dark mb-2">{member.name}</h3>
        ...
        <section className="py-20 bg-neutral-muted">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-brand-dark mb-6">How We Work</h2>
              <p className="text-xl text-text-muted max-w-2xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-brand-dark mb-4">{process.title}</h3>
                  <p className="text-text-muted leading-relaxed">{process.desc}</p>
                </div>
              ))}
            </div>
          </div>
